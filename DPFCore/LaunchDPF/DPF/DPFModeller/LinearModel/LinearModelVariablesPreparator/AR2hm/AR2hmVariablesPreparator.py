...
class AR2hmVariablesPreparator(LinearModelVariablesPreparator):
    ...
    def _prepare_additional_input_data(self):
        ...
        self._linear_regression_input_data = self._linear_regression_input_data + [pd_max, pd_avg, d_hol, pd_minus1_24]